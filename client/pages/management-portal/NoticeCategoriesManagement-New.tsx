...
export default function NoticeCategoriesManagement() {
  ...
  const handleSaveCategory = async () => {
    ...
    try {
      ...
      const url = editingCategory 
        ? `/.netlify/functions/api/admin/notice-categories/${editingCategory.id}`
        : '/.netlify/functions/api/admin/notice-categories';
  ...
  const handleDeleteCategory = async (categoryId: string) => {
    try {
      ...
      const response = await fetch(`/.netlify/functions/api/admin/notice-categories/${categoryId}`, {
        method: 'DELETE',
        credentials: 'include'
      });
        ...
        <div className="text-center">
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Tag className="h-6 w-6 animate-pulse" style={{ color: COLORS.primary[600] }} />
            </div>
          </div>
          <h3 className="text-lg font-bold mb-2" style={{ color: COLORS.neutral[900] }}>Loading Categories</h3>
          <p style={{ color: COLORS.neutral[600] }}>Fetching notice categories...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6" style={{ backgroundColor: COLORS.neutral[50] }}>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold" style={{ color: COLORS.neutral[900] }}>Notice Categories</h1>
          <p className="mt-2" style={{ color: COLORS.neutral[600] }}>Organize notices into meaningful categories for better management</p>
        </div>
        {user?.role === 'admin' && (
          <Button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              >
                <Tag className="h-6 w-6" style={{ color: COLORS.primary[600] }} />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-sm" style={{ color: COLORS.success[600] }}>Active Colors</p>
              ...
              >
                <Palette className="h-6 w-6" style={{ color: COLORS.success[600] }} />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        >
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-sm" style={{ color: COLORS.accent[600] }}>Avg. Name Length</p>
                <p className="text-2xl font-bold" style={{ color: COLORS.neutral[900] }}>
                  {categories.length > 0 
                    ? Math.round(categories.reduce((sum, c) => sum + c.name.length, 0) / categories.length)
                    : 0
                  } chars
                </p>
              </div>
              ...
              >
                <Hash className="h-6 w-6" style={{ color: COLORS.accent[600] }} />
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      {filteredCategories.length === 0 ? (
        ...
        >
          <CardContent className="p-12 text-center">
            <Tag className="h-16 w-16 mx-auto mb-4" style={{ color: COLORS.neutral[300] }} />
            ...
            <p className="mb-6" style={{ color: COLORS.neutral[600] }}>
              {searchTerm
                ...
                : 'Get started by creating your first notice category'
              }
            </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        <Tag className="h-5 w-5" style={{ color: badgeStyle.color }} />
                      </div>
                      <div>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Are you sure you want to delete "{category.name}"? This action cannot be undone and may affect existing notices.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingCategory ? 'Update category information and settings' : 'Create a new category to organize notices'}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="e.g., Academic, Events, Announcements"
              />
            </div>

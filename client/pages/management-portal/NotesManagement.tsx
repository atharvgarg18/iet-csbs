...
export default function NotesManagement() {
  ...
  const fetchNotes = async () => {
    try {
      ...
      const response = await fetch('/.netlify/functions/api/notes', {
        method: 'GET',
        credentials: 'include',
        headers: {
  ...
  const handleSaveNote = async () => {
    ...
    try {
      ...
      const url = editingNote 
        ? `/.netlify/functions/api/notes/${editingNote.id}`
        : '/.netlify/functions/api/notes';
  ...
  const handleDeleteNote = async (noteId: string) => {
    try {
      ...
      const response = await fetch(`/.netlify/functions/api/notes/${noteId}`, {
        method: 'DELETE',
        credentials: 'include'
      });

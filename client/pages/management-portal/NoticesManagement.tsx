        ...
        <div className="text-center">
          <div className="relative mb-6">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Bell className="h-6 w-6 animate-pulse" style={{ color: COLORS.primary[600] }} />
            </div>
          </div>
          <h3 className="text-lg font-bold mb-2" style={{ color: COLORS.neutral[900] }}>Loading Notices</h3>
          <p style={{ color: COLORS.neutral[600] }}>Fetching latest announcements...</p>
        </div>
      </div>
    );
  }
